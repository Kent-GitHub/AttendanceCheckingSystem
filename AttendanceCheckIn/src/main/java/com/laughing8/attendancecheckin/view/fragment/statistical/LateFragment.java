...
public class LateFragment extends SecondFragment implements DataQuery.OnQueryFinishListener, View.OnClickListener {
    ...
    private LateFragment.MyAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_late, null);
        mListView = (ListView) view.findViewById(R.id.FLListView);
        mListView.setAdapter(mAdapter);
        mProgressBar = (ProgressBar) view.findViewById(R.id.fragmentLateProgressBar);
        ...
        view.findViewById(R.id.lateTimesTv).setOnClickListener(this);
        view.findViewById(R.id.lateCountTv).setOnClickListener(this);
    ...
    private void initData(List result) {
        int swSecond = mDataShare.getSWSecond();
        ...
        for (RecordByMouth record : records) {
            ...
            try {
                ...
                lateRecord.lateTimeCount += time - swSecond;
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.lateTimesTv:
                sortByTimes();
                break;
            case R.id.sort_by_timeCount:
            case R.id.lateCountTv:
                sortByTimeCount();
                break;
        }
    }
