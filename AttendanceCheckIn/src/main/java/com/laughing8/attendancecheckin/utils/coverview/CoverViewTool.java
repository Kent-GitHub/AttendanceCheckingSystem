...
public class CoverViewTool {
     ...
     * @param activity
     */
    public CoverViewTool(Activity activity, View view) {
        init(activity);
        cover(view);
    }
    ...
    public void cover(final View view) {
        ...
        beCover.addOnLayoutChangeListener(new OnLayoutChangeListener() {
